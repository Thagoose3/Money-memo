...
const TRANSLATIONS = {
  th: {
    ...
    settings_paycycle_title: 'รอบบัญชี & วันเงินเดือนออก (Payday Cycle)',
    settings_paycycle_desc: 'กำหนดวันตัดรอบเงินเดือนเพื่อคำนวณรายรับ-รายจ่าย และยอดเงินคงเหลือในหน้าหลัก สเตทเมนต์ และสถิติให้ตรงกับชีวิตจริง',
    settings_savings_goal_title: 'เป้าหมายเงินออมรายเดือน (Monthly Savings Target)',
    settings_savings_goal_desc: 'กำหนดจำนวนเงินที่ตั้งใจจะเก็บในแต่ละเดือน เพื่อนำไปคำนวณโควต้าเงินกินใช้รายวันแบบ Dynamic Rolling บนหน้าหลัก',
    savings_goal_label: 'เป้าหมายเงินออมเดือนนี้:',
    savings_goal_modal_title: 'ปรับเป้าหมายเงินออมรายเดือน',
    savings_goal_modal_desc: 'ระบบจะนำเป้าหมายเงินออมนี้ไปหักลบออกจากรายรับจริง เพื่อคำนวณโควต้าเงินกินใช้วันต่อวันให้พอดีกับวันที่เหลือในรอบเดือน',
    daily_quota_title: 'โควตาเงินกินใช้วันนี้',
    daily_quota_remaining_today: 'วันนี้ใช้ได้อีก',
    daily_quota_target_today: 'งบแนะนำวันนี้',
    daily_quota_days_left: 'เหลืออีก {0} วันในรอบ',
    daily_quota_spent_today: 'ใช้ไปแล้ววันนี้: ฿{0}',
    daily_quota_savings_target: 'เป้าหมายเงินออม: ฿{0}',
    daily_quota_cycle_income: 'รายรับรอบนี้: ฿{0}',
    daily_quota_cycle_past_expense: 'จ่ายสะสมก่อนวันนี้: ฿{0}',
    btn_adjust_savings_goal: '🎯 ปรับเป้าเงินออม',
    cycle_opt_end_of_month: 'วันสิ้นเดือน (เช่น 31 ส.ค. - 30 ก.ย.)',
    cycle_opt_end_of_month_desc: 'สำหรับผู้ที่เงินเดือนออกทุกวันสุดท้ายของเดือน',
    cycle_opt_calendar: 'เดือนปฏิทิน (วันที่ 1 - สิ้นเดือน)',
    cycle_opt_calendar_desc: 'ค่าเริ่มต้นมาตรฐานทั่วไป (1 ก.ย. - 30 ก.ย.)',
    cycle_opt_day_25: 'วันที่ 25 (25 ส.ค. - 24 ก.ย.)',
    cycle_opt_day_25_desc: 'สำหรับพนักงานที่เงินเดือนออกวันที่ 25',
    cycle_opt_day_28: 'วันที่ 28 (28 ส.ค. - 27 ก.ย.)',
    cycle_opt_day_28_desc: 'สำหรับพนักงานที่เงินเดือนออกวันที่ 28',
    cycle_opt_custom: 'กำหนดวันตัดรอบเอง',
    cycle_current_preview: 'รอบปัจจุบันของคุณ:',
    cycle_badge_calendar: 'เดือนปฏิทิน',
    cycle_badge_end_of_month: 'วันสิ้นเดือน',
    cycle_badge_custom: 'ตัดรอบวันที่',
    history_mode_cycle: '💼 รอบเงินเดือน',
    history_mode_calendar: '📆 เดือนปฏิทิน',
    ...
    view_custom: '📊 สรุปรายเดือน / กำหนดช่วงวัน',
    view_daily: '📅 แจกแจงรายวัน',
    view_yearly: '📆 สรุปภาพรวมรายปี',

    label_custom_date_range: 'กำหนดช่วงวันที่:',
    label_start_date: 'ตั้งแต่วันที่',
    label_end_date: 'ถึงวันที่',
    kpi_custom_income_sub: 'ยอดรับทั้งหมดในช่วงวันที่เลือก',
    kpi_custom_expense_sub: 'ยอดใช้จ่ายทั้งหมดในช่วงวันที่เลือก',
    kpi_custom_net_sub: 'รายรับ - รายจ่าย ในช่วงนี้',
    ...
    chart_category_empty: 'ยังไม่มีรายการรายจ่ายในช่วงนี้',
    top_categories_title: 'หมวดหมู่ที่ใช้เงินมากที่สุด (Top 5)',
    top_categories_empty: 'ยังไม่มีข้อมูลการใช้จ่ายในช่วงนี้',
    top_categories_tip: '💡 ตรวจสอบหมวดหมู่หลักเพื่อช่วยลดรายจ่ายที่ไม่จำเป็นในรอบถัดไป',
    ...
    daily_breakdown_empty: 'ไม่มีรายการใช้จ่ายในช่วงเวลานี้',
    ...
    sim_days_custom_hint: 'กำหนดเองได้อิสระ',
    sim_days_suffix: 'วัน',
  ...
  en: {
    ...
    settings_paycycle_title: 'Payday & Financial Cycle',
    settings_paycycle_desc: 'Configure monthly payday cut-off to accurately compute income, expenses, and balances across Home, Statement, and Dashboard.',
    settings_savings_goal_title: 'Monthly Savings Target',
    settings_savings_goal_desc: 'Set your intended monthly savings to dynamically calculate daily spending allowances on the Home screen.',
    savings_goal_label: 'Savings Target This Month:',
    savings_goal_modal_title: 'Adjust Monthly Savings Target',
    savings_goal_modal_desc: 'This savings goal will be deducted from your real income to compute your rolling daily spending allowance.',
    daily_quota_title: 'Daily Spending Allowance',
    daily_quota_remaining_today: 'Remaining Today',
    daily_quota_target_today: 'Daily Target',
    daily_quota_days_left: '{0} days left in cycle',
    daily_quota_spent_today: 'Spent today: ฿{0}',
    daily_quota_savings_target: 'Savings Goal: ฿{0}',
    daily_quota_cycle_income: 'Cycle Income: ฿{0}',
    daily_quota_cycle_past_expense: 'Prior Expenses: ฿{0}',
    btn_adjust_savings_goal: '🎯 Adjust Goal',
    cycle_opt_end_of_month: 'End of Month (e.g. 31 Aug - 30 Sep)',
    cycle_opt_end_of_month_desc: 'For users who receive salary on the last day of each month',
    cycle_opt_calendar: 'Calendar Month (1st - End of Month)',
    cycle_opt_calendar_desc: 'Standard default calendar month (1 Sep - 30 Sep)',
    cycle_opt_day_25: '25th of Month (25 Aug - 24 Sep)',
    cycle_opt_day_25_desc: 'For employees with payday on the 25th',
    cycle_opt_day_28: '28th of Month (28 Aug - 27 Sep)',
    cycle_opt_day_28_desc: 'For employees with payday on the 28th',
    cycle_opt_custom: 'Custom Cut-off Day',
    cycle_current_preview: 'Your current financial cycle:',
    cycle_badge_calendar: 'Calendar Month',
    cycle_badge_end_of_month: 'End of Month',
    cycle_badge_custom: 'Cycle Day',
    history_mode_cycle: '💼 Payday Cycle',
    history_mode_calendar: '📆 Calendar Month',
    ...
    view_custom: '📊 Monthly / Custom Range',
    view_daily: '📅 Daily Breakdown',
    view_yearly: '📆 Annual Overview',

    label_custom_date_range: 'Custom Date Range:',
    label_start_date: 'Start Date',
    label_end_date: 'End Date',
    kpi_custom_income_sub: 'Total income in selected period',
    kpi_custom_expense_sub: 'Total spent in selected period',
    kpi_custom_net_sub: 'Income minus Expenses in this period',
    ...
    yearly_income: 'Total Annual Income',
    yearly_income_sub: 'Total income throughout the year',
    yearly_expense: 'Total Annual Expense',
    yearly_expense_sub: 'Total expenses throughout the year',
    yearly_savings: 'Annual Net Savings',
    yearly_savings_sub: 'Annual Income minus Expenses',
    yearly_savings_rate: 'Annual Savings Rate',
    yearly_savings_rate_sub: 'Savings percentage of annual income',
    ...
    chart_category_empty: 'No expense records found in this period',
    top_categories_title: 'Top 5 Expense Categories',
    top_categories_empty: 'No spending data in this period',
    top_categories_tip: '💡 Monitor top categories to optimize discretionary spending for next cycle.',
    chart_daily_trend_title: 'Daily Spending Trend',
    chart_monthly_bar_title: '12-Month Income vs Expense Comparison',
    chart_yearly_category_title: 'Annual Spending by Category',
    yearly_table_title: '12-Month Financial Performance Table',
    th_month: 'Month',
    th_income: 'Income (฿)',
    th_expense: 'Expense (฿)',
    th_net: 'Net Balance (฿)',
    th_savings_rate: 'Savings %',
    daily_breakdown_title: 'Daily Breakdown',
    daily_breakdown_empty: 'No transactions found for this period',
    ...
    sim_days_custom_hint: 'Customizable',
    sim_days_suffix: 'days',
